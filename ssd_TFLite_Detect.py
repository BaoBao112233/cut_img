...
from ssd_Detect import polygon_calculate
import json

with open('polygon.json', 'r') as json_file:
    data = json.load(json_file)

HEIGHT_VIDEO = data['size_height']
WIDTH_VIDEO = data['size_width']
...
while(video.isOpened()):
    ...
    frame_org, frame = cut_frame_polygon(frame_resized)
    # Scale màn hình và polygon 
